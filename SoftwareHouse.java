...
public class SoftwareHouse 
{
    ...
    {
        name = ""; 		//setName(""); will throw illegal args exception
        street = ""; 	//setStreet("");
        city = ""; 		//setCity("");
        state = ""; 	//setState("");
        zip = ""; 		//setZipcode("00000");
    }
     ...
     * @return Returns true if the zip code is at least 5 characters long and false 
     *	otherwise.  If false is returned, then setting the zipcode failed.
     */
    public void setZipcode(String zipcode) 
    {	//needs to be void - not boolean
    	//change return false to IllegalArgumentException
    	if (zipcode.length() < 5 || zipcode.length() > 5) {
    		throw new IllegalArgumentException("Zipcode must be 5 characters long.");
    	}
    	zip = zipcode;
        //return true; 
    }
    ...
    {
        return zip; //return street; should be zip not street
    }
    ...
    {
        //String str = "Company Name: "+name+  	//simplified in return line (instead of return str)
