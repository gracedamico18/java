...
public class WebStore
{
	public static void main(String[] args)
	{
		...
		double[] priceArray = {0, 180.0, 85.0, 12.0, 250.0, 95.0, 770.0, 55.0, 300.0, 60.0, 40.0};
		int[] shoppingCart = new int[11];
		...
		do
		{
			...
			switch(menuChoice)
			{
				...
				case 1:	//view item selection
					//TO-DO: write print statements to print the item selections
					System.out.println("\nItem selection:");
				...
				case 2:	//view shopping cart
					...
					else
					{
						...
						for (int i = 0; i < shoppingCart.length; i++)
						{
							if (shoppingCart[i] > 0)
							{
								...
								System.out.printf("%-25s%-25d$%10.2f\n", itemNames[i], shoppingCart[i], priceArray[i] * shoppingCart[i]);
							}
						}
					}
					...
					case 3:	//add item to cart
						...
						System.out.println("Added " + quantity + " " + itemNames[itemNumber] + " to your cart.");
					...
					case 4:	//remove item from cart
						...
						if (quantity > shoppingCart[itemNumber])
						{
							...
							System.out.print("You have " + shoppingCart[itemNumber] + " " + itemNames[itemNumber] + " in your cart.  " + "Nothing was removed.\n");
						}
						else
						{
							...
							System.out.println("Removed " + quantity + " " + itemNames[itemNumber] + " from your cart.");
					...
					case 5:	//checkout
						...
						userAccountNumber = keyboard1.nextLine();
						...
						do
						{
							...
							else
							{
								...
								System.out.print("I'm sorry, that number is invalid. Please try again: ");
								userAccountNumber = keyb.nextLine();
							}
